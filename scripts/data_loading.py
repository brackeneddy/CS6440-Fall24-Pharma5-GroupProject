...
def load_and_merge_data():
    ...
    dir1 = 'data/raw/mturkfitbit_export_3.12.16-4.11.16/Fitabase Data 3.12.16-4.11.16'
    dir2 = 'data/raw/mturkfitbit_export_4.12.16-5.12.16/Fitabase Data 4.12.16-5.12.16'
    ...
    for key, file_name in files_to_load.items():
        ...
        if df1 is not None and df2 is not None:
            ...
            print(f"Warning: Both files for {file_name} are empty. Skipping.")
            continue
